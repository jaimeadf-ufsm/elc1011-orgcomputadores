...
inst_def_slti:    definst("slti #1, #0, #2", OP_REG, OP_REG, OP_IMM_SIG, OP_NONE)
inst_def_sltiu:   definst("sltiu #1, #0, #2", OP_REG, OP_REG, OP_IMM_UNSIG, OP_NONE)
inst_def_andi:    definst("andi #1, #0, #2", OP_REG, OP_REG, OP_IMM_UNSIG, OP_NONE)
inst_def_ori:     definst("ori #1, #0, #2", OP_REG, OP_REG, OP_IMM_UNSIG, OP_NONE)
inst_def_xori:    definst("xori #1, #0, #2", OP_REG, OP_REG, OP_IMM_UNSIG, OP_NONE)
